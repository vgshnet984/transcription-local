...
class UploadHandler {
    ...
    async uploadFile(file, onProgress) {
        return new Promise((resolve, reject) => {
            ...
            // Add new options
            formData.append('no_filtering', document.getElementById('no_filtering').checked);
            formData.append('suppress_logs', document.getElementById('suppress_logs').checked);
...
// Add to your existing upload function
function uploadFile() {
    const formData = new FormData();
    ...
    formData.append('model_size', document.getElementById('model_size').value);
    formData.append('language', document.getElementById('language').value);
    formData.append('vad_method', document.getElementById('vad_method').value);
    formData.append('enable_speaker_diarization', document.getElementById('enable_speaker_diarization').checked);
...
// Update the engine status check
    ...
    fetch('/engine-status')
        ...
        .then(data => {
            ...
            if (data.status === 'ready') {
                statusElement.innerHTML = `
                    ...
                    <br><small>Model: ${data.model_info.current_model} | Device: ${data.model_info.current_device}</small>
                `;
            } else {
                statusElement.innerHTML = `
                    <span class="status-error">❌ Engine Error</span>
        ...
        .catch(error => {
            ...
            document.getElementById('engine-status').innerHTML = `
                ...
                <br><small>Check server connection</small>
            `;
        });
} 