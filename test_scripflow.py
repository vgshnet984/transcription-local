#!/usr/bin/env python3
"""
Test script for Scripflow (port 8001)
...
def test_scripflow():
    """Test the Scripflow functionality."""
    base_url = "http://localhost:8001"
    sample_audio = "examples/sample_audio/tes1_first_35s"
    
    print("🧪 Testing Scripflow (port 8001)")
    print("=" * 50)
    ...
    try:
        ...
        if response.status_code != 200:
            print("❌ Scripflow server not responding")
            return False
        print("✅ Scripflow server is running")
    except requests.exceptions.RequestException:
        print("❌ Scripflow server not accessible")
        return False
    ...
    print("\n🎉 Scripflow test completed successfully!")
    return True

if __name__ == "__main__":
    success = test_scripflow()
